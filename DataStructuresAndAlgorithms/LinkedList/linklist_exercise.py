"""
   Module for attempting Linked List Questions
"""

from linkedlist import LinkedList, Node

def return_middle_node(ll: LinkedList):
...
def k_th_from_end(ll: LinkedList, k: int):
    """
...
def binary_to_decimal(ll: LinkedList):
    """
...
def partition_list(ll: LinkedList, x: int):
    """
...
def reverse_between(ll: LinkedList, start: int, end: int):
    """
